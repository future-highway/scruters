...
impl Group {
    pub fn all_auto_generated_groups(
        message_tx: UnboundedSender<Message>,
    ) -> Vec<Self> {
        let all_tests = "All tests ✨";
        let all_tests = Self {
            name: all_tests.into(),
            kind: GroupKind::AutoGenerated(
                AutoGeneratedGroup::all_tests(
                    all_tests.into(),
                    message_tx.clone(),
                ),
            ),
        ...
        let integration_tests = Self {
            ...
            kind: GroupKind::AutoGenerated(
                AutoGeneratedGroup::integration_tests(
