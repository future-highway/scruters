...
use groups::{
    ...
    AnyGroup, Group, GroupName, GroupOutputCaptureMode,
    Groups,
};
            ...
            TestingMessage::OutputFromTestRun(
                ...
                let return_message =
                    ...
                    } = &test
                    {
                        ...
                        Some(Message::Testing(TestingMessage::OutputFromGroupRun(group_name, line.clone())))
                    } else {
                        None
                    };
