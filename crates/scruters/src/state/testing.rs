...
use groups::{
    auto_generated_groups::AutoGeneratedGroup, AnyGroup,
    Group, GroupName, GroupOutputCaptureMode, Groups,
};
...
pub(crate) struct TestingState {
    ...
    pub groups: Groups,
    #[serde(skip, default)]
    pub tests_output: HashMap<Test, TestResult>,
    #[serde(skip, default)]
            ...
            TestingMessage::OutputFromGroupRun(
                ...
                if_chain! {
                    ...
                    then {
                        ...
                        let test_result = self.tests_output
                ...
                ) = capture_mode
                {
                    if let Some(test_result) =
                        self.tests_output.get_mut(test)
                    {
                        test_result
                            .output
                            .push(line.clone());
